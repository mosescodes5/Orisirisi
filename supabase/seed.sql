...
values
  ('woven-storage-basket-set', 'Woven Storage Basket Set (3pc)', 'Household', 'Home functionality', 24500, null, 'orisirisi-p1', 'Hand-woven baskets in three nesting sizes — sisal and seagrass blend, sturdy enough for daily use.', true, true, 20),
  ...
  ('ceramic-table-lamp-ivory', 'Ceramic Table Lamp — Ivory', 'Household', 'Home functionality', 32000, null, 'orisirisi-p4', 'Hand-glazed ceramic base with a natural linen shade, warm-white bulb included.', false, true, 20),
  ...
  ('scented-soy-candle-set', 'Scented Soy Candle Set', 'Household', 'Home functionality', 13000, null, 'orisirisi-p7', 'Set of two hand-poured soy candles — sandalwood and citrus grove.', false, true, 20),
