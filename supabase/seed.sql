...
values
  ...
  ('linen-wrap-top-sand', 'Linen Wrap Top — Sand', 'Clothing', 'Tops', 15200, null, 'orisirisi-p3', 'Breathable linen wrap top, true to size, hand-wash recommended.', true, true, 20),
  ...
  ('structured-tote-bag-tan', 'Structured Tote Bag — Tan', 'Accessories', 'Bags', 27500, null, 'orisirisi-p6', 'Vegan leather tote with a structured base, fits a 13-inch laptop.', false, true, 20),
  ...
  ('silk-hair-scarf-rust', 'Silk Hair Scarf — Rust', 'Accessories', 'Hair', 7200, null, 'orisirisi-p8', '100% mulberry silk scarf, hand-rolled edges, one size.', true, true, 20),
