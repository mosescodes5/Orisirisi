...
import { getCurrentCustomer, getMyOrderByReference } from "@/lib/customer/queries";
...
export default async function CustomerOrderDetailPage({
  ...
  const order = await getMyOrderByReference(reference);
      ...
      <div className="mx-auto max-w-[720px]">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.6fr_1fr]">
          ...
          <div className="h-fit rounded-2xl border border-ink/[0.08] bg-paper">
            <div className="border-b border-ink/[0.08] px-6 py-5">
              <h2 className="font-display text-[19px] font-medium">Delivery details</h2>
            </div>
